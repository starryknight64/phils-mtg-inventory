  ...
  <div id="main">
    ...
    <g:if test="${haveQuery && !haveResults && !parseException}">
      ...
      <g:if test="${!searchResult?.suggestedQuery}">
		...
		The simplest way to do this is add <strong>spellCheck "include"</strong> to the domain class search mapping closure.<br />
    ...
    <g:if test="${searchResult?.suggestedQuery}">
      <p>Did you mean <b><i><g:link controller="search" action="index" params="[q: searchResult.suggestedQuery]">${searchResult.suggestedQuery}</g:link></i></b>?</p>
    </g:if>
